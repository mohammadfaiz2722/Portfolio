  ...
  return (
    <div className='wrapper'>
      ...
      <div className='about-box text custom'>
        ...
        <p className='none-hobby'><strong>My Hobbies</strong></p>Prepare for a whirlwind tour through the chaos that is my life of hobbies! When I’m not busy conjuring code magic to create entire virtual realms (yes, I’m basically a digital wizard), I’m diving headfirst into epic battles in games like BGMI or plotting strategic triumphs in Clash of Clans. And let me tell you, resisting the siren song of competition is about as easy as herding cats – which is why you’ll often find me on the field, dodging cricket balls or executing ninja-like moves in a football match. The camaraderie with teammates is fantastic, even if we occasionally trip over our own feet (literally). Now, to keep my mind sharper than Excalibur and my body more energized than a hyperactive Pikachu, I hit the gym religiously. It’s where I sculpt my coding muscles, hone my virtual battle skills, and maybe even learn a thing or two about lifting heavy stuff. Because let’s face it, whether I’m coding my way to victory, conquering digital realms, or attempting to kick a ball without tripping, it’s all about having a blast – and maybe a few bruises along the way! </div>
      </div>
    </div>
  );
}
